...
describe('StaffAdjustmentEngine', () => {
  ...
  describe('作用点2: resolveAffinity', () => {
    ...
    it('外舘(id="00000000-0000-0000-0000-000000000103")はsubscriptionStyle="document_handover"が設定される', () => {
      const engine = new StaffAdjustmentEngine();
      const staff = buildStaff({ id: '00000000-0000-0000-0000-000000000103', name: '外舘', style: 'empathy' });
