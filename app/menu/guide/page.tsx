    ...
    >
      ...
      >
        <div className="px-4 pt-4 space-y-5">
          ...
          <Card emoji="🔒" title="セキュリティ・安心設計" color="#6B95BE">
            <T>Riora OSでは、お客様情報を安全に管理するため、以下の設計を行っています。</T>
            <T>・お客様情報は必要最低限の情報のみを管理し、安全な環境で保管しています。</T>
            <T>・AI機能を利用する際は、必要な情報だけを使用し、お客様の大切な情報を守る設計になっています。</T>
            <T>・音声メモは用途ごとに管理され、不要な情報が広がらない仕組みになっています。</T>
            <T>・スタッフごとの利用範囲を管理し、安心して業務で利用できる環境を整えています。</T>
            <T>・お客様へのメッセージ送信は確認フローを設け、誤送信を防止しています。</T>
          </Card>
