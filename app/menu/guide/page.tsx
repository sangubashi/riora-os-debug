      ...
      >
        <div className="px-4 pt-4 space-y-5">
          ...
          <Card emoji="👤" title="2. 顧客タブ" color="#78A8D8">
            ...
            <T>お名前・来店回数・累計売上・最終来店日を一覧で確認できます。全スタッフが全顧客を閲覧でき、直近の来店が新しい順に並びます。名前・タイプ・担当者名・施術名で検索できます。</T>
            ...
            <T>・カルテメモ：紙のカルテなど過去の記録は、AIによる自動抽出ではなく、カルテメモへの手入力で記録する運用です。</T>
          ...
          <Card emoji="🤖" title="4. AI提案" color="#D98292">
            ...
            <T>顧客情報の画面やAI Timelineに表示される、その日の接客で意識したいポイントです。記録された重要メモ（過去の会話・接客記録）をもとに表示されます。</T>
          ...
          <Card emoji="🔒" title="9. セキュリティ・情報管理" color="#6B95BE">
            ...
            <T>・お客様の情報は、担当や当日の予約状況に関わらず、全スタッフが確認できます。「担当」の表示は誰が主に対応しているかの情報であり、閲覧できるかどうかには影響しません。</T>
